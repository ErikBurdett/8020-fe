...
const CardList: React.FC<CardListProps> = ({ isDarkMode }) => {
  // You can now use isDarkMode within your component, if needed
  // The Card component and its children will still automatically use the theme provided by ThemeProvider
